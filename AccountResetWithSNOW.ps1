...
$uri = "https://flybedev.service-now.com/api/now/table/incident"
...
$body = @"
{"short_description":"$umail has been compromised","caller_id":"Rory Smith","description":"$umail has been compromised, please contact the user to reset their password and enforce MFA","location":"Training Academy","contact_type":"Phone","u_contact_email_address":"cyber.security@flybe.com","category":"Software","subcategory":"Email","impact":"3","urgency":"1","state":"1","assignment_group":"Cyber Security","business_service":"Cyber Security","u_contact_phone_number":"Skype"}
...
$snowuri = "https://flybedev.service-now.com/nav_to.do?uri=%2Fincident.do%3Fsys_id%3D" + $response.result.sys_id
...
Send-MailMessage -To cyber.security@flybe.com -from cyber.security@flybe.com -Subject 'Account Compromise: TEST TEST ' -Body $body -BodyAsHtml -smtpserver smtp.office365.com -usessl -Credential $AzureAdCred -Port 587 
